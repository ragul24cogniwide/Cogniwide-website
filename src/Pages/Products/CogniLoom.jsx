...
const CogniLoom = () => {
  ...
  const ArrowDown = ({ className = "" }) => (
    <svg width={24} height={24} fill="none" className={className} viewBox="0 0 24 24">
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-20 p-4">
        {/* Left Side */}
        ...
        <div className="flex-1 w-full flex justify-center items-center lg:justify-end lg:items-center">
          <div className="bg-[#232427] rounded-2xl px-8 py-10 w-full max-w-md flex flex-col items-center justify-center gap-8 shadow-lg">
            {/* Item 1 */}
      ...
      <section className=" bg-[var(--color-background)] px-4 py-16 fade-in">
        <div className="mb-12 text-center">
          <h2 className="text-3xl font-extrabold text-transparent bg-clip-text  mb-2"
                style={{
                  backgroundImage: "linear-gradient(var(--color-purpletext), var(--color-purpletext))"
                }}>
